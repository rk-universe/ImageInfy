...
// Get Started button click event listener
function updateget_started(){
const getStartedButton =document.getElementById('get_started_home');
if (currentUser) {
    console.log("in")
    if (userData.file_uploaded) {
        getStartedButton.href = "../generate_iamge2/index.html";
    } else {
        getStartedButton.href = "../File_Uploader/index.html";
    }
} else {
    getStartedButton.href = "../SignIn-SignUp-Form-main/index.html";
}
}

// export default {currentUser,userData}
export const currentUser1=currentUser;
